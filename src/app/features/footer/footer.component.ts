...
export class FooterComponent {
  ...
  protected readonly socialLinks: SocialLink[] = [
    ...
    },
    {
      ...
      platform: 'LinkedIn',
      url: 'https://www.linkedin.com/in/francisco-javier-antunez-duran/',
    },
    {
      ariaLabel: 'X (Twitter) profile',
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.742l7.735-8.835L1.254 2.25H8.08l4.26 5.632zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
      </svg>`,
      platform: 'X',
      url: 'https://x.com/anbreaker',
    },
  ];
}
